...
export const STORY: Record<string, Scene> = {
  start: {
    beats: [
      ...
      {
        kind: "narration",
        text: "공직생활은 선택의 연속이다.\n점수는 보이지 않지만, 결과는 반드시 남는다.\n하지만 결과는 늘 큰 선택에서만 갈리지 않는다.",
      },
    ],
    next: "stage1_intro",
  },
  ...
  ending_passive: {
    beats: [
      ...
      {
        kind: "narration",
        text: "결정해야 할 순간마다 당신은 한발 물러섰다.\n어떤 선택이 옳았는지 몰라서라기보다, 먼저 판단할 책임을 미루고 싶었던 쪽에 가까웠다.",
      },
      {
        kind: "narration",
        text: "문제는 늘 누군가 대신 정리했고, 책임은 조용히 주변 사람들에게로 흩어졌다.\n누군가 해주길 기다리는 동안, 기준을 세울 기회도 함께 지나가 버렸다.",
      },
      {
        kind: "narration",
        text: "아무것도 결정하지 않는 태도 역시 하나의 선택이었다.\n그리고 그 선택은, 결국 아무것도 지켜내지 못한 채 남았다.",
      },
